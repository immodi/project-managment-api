...
public class UpdateTaskStatusTests
{
    ...
    [Fact]
    public async Task Should_update_task_status_when_user_is_owner()
    {
        var userId = UserId();
    ...
    public async Task Should_throw_when_task_not_found()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() =>
            _service.UpdateStatusAsync(taskId, TaskStatus.Done, UserId()));
    }
    ...
    public async Task Should_throw_when_user_is_not_owner()
    {
        ...
        await Assert.ThrowsAsync<NotFoundException>(() =>
            _service.UpdateStatusAsync(task.Id, TaskStatus.Done, otherUserId));
    }
}